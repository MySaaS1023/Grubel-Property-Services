      ...
      <section className="bg-white py-14">
        <div className="site-container">
          <div className="mx-auto max-w-4xl space-y-4 leading-7 text-charcoal/75 [&_h2]:pt-4 [&_h2]:text-2xl [&_h2]:font-black [&_h2]:text-navy">
            ...
            <p>
              Any estimate, quote, message, or walkthrough is limited to the
              work specifically described. Additional conditions discovered
              during work may require a revised scope, additional approval,
              specialty trade referral, or separate quote.
            </p>
            ...
            <p>
              Scheduling depends on availability, property access, project
              scope, and required materials or vendors. Customers are
              responsible for providing lawful access, accurate property
              information, and any required permissions.
            </p>
            <h2>Payment Expectations</h2>
            <p>
              Deposits, progress payments, or final payments may be required
              based on the approved quote or service scope. Work may be paused
              or rescheduled if payment or approval requirements are not met.
            </p>
            <h2>Contractor Coordination</h2>
            <p>
              When specialty contractors or vendors are involved, Grubel
              Property Services may assist with coordination, documentation, and
              scheduling. Third-party work, licensing, warranties, and
              performance remain subject to the applicable provider.
            </p>
            ...
            <p>
              ...
              customer-provided information, unauthorized property access, or
              work performed by unapproved third parties.
            </p>
          </div>
        </div>
      </section>
