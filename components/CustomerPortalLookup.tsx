...
export function CustomerPortalLookup() {
  ...
  const requiresPayment = quote?.paymentStatus === "Unpaid";
      ...
      {quote ? (
        <article className="rounded-lg border border-slate-200 bg-stonewash p-6 shadow-sm">
          ...
          {requiresPayment ? (
            <div className="mt-6 rounded-md bg-white p-4">
              <div className="text-sm font-black text-navy">
                Payment is still required before scheduling can be confirmed.
              </div>
              <Button className="mt-4" href="/payment">
                Make Payment
              </Button>
            </div>
          ) : null}
          ...
          <DashboardSection title="Project Overview">
            ...
            <PortalField label="Customer Name" value={quote.customerName} />
          </DashboardSection>

          <DashboardSection title="Service Status">
            <PortalField label="Current Status" value={quote.serviceStatus} />
          ...
          <DashboardSection title="Scheduled Date">
            <PortalField label="Schedule" value={quote.scheduledDate} />
          </DashboardSection>

          <DashboardSection title="Assigned Team">
            <PortalField label="Team" value={quote.assignedTeam} />
          </DashboardSection>
